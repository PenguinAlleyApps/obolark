...
export const WARDEN_PROVIDER_MAP: Record<EndpointKey, ProviderTarget> = {
  ...
  // Gemini Pro Deep-Think passthrough — dispatched directly in bureau/moros-arbiter/route.ts
  'bureau/moros-arbiter': { provider: 'aisa', model: '-', maxTokens: 0, timeoutMs: 0 },
};
