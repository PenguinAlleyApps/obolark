...
export const WARDEN_PROVIDER_MAP: Record<EndpointKey, ProviderTarget> = {
  ...
  'bureau/atlas':        { provider: 'aisa', model: 'claude-opus-4-5-20251101',  maxTokens: 420, timeoutMs: 22_000 },
  'bureau/hermes':       { provider: 'aisa', model: 'claude-haiku-4-5-20251001', maxTokens: 360, timeoutMs: 18_000 },
  'bureau/iris':         { provider: 'aisa', model: 'claude-haiku-4-5-20251001', maxTokens: 480, timeoutMs: 18_000 },
  'bureau/artemis':      { provider: 'aisa', model: 'claude-haiku-4-5-20251001', maxTokens: 380, timeoutMs: 18_000 },
  'bureau/urania':       { provider: 'aisa', model: 'claude-haiku-4-5-20251001', maxTokens: 420, timeoutMs: 18_000 },
  ...
  'bureau/helios':       { provider: 'aisa', model: 'claude-haiku-4-5-20251001', maxTokens: 480, timeoutMs: 18_000 },
  ...
  'bureau/calliope':     { provider: 'aisa', model: 'claude-haiku-4-5-20251001', maxTokens: 420, timeoutMs: 18_000 },
